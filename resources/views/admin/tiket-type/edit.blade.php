<x-layouts.admin title="Edit Tipe Tiket">
    <div class="container mx-auto p-6 lg:p-10 max-w-2xl">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Tipe Tiket</h1>
        ...
        <div class="card bg-white shadow-xl border border-gray-100 rounded-2xl">
            <form action="{{ route('admin.tiket-types.update', $tiketType->id) }}" method="POST" class="card-body">
                @csrf
                @method('PUT')
